...
export function LoginForm() {
  ...
  async function onSubmit(data: FormData) {
    ...
    try {
      ...
      router.push(user.onboardingCompleted ? "/feed" : "/onboarding")
    } catch (err: any) {
    ...
    >
      ...
      <div className="space-y-1">
        ...
        <p className="text-sm text-white/40">
          ...
          <Link href="/register" className="text-white hover:text-white font-medium transition-colors">
            Sign up free
          </Link>
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="space-y-1.5">
          ...
          <input
            ...
            autoComplete="email"
            className={cn("input", errors.email && "border-red-500/40 focus:border-red-500/60")}
          />
